      ...
      <div className="container mx-auto px-4 py-16">
            ...
            <div className="flex items-center gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center text-white/50 hover:text-pink-400 hover:bg-white/10 transition-colors"
        ...
        <div className="mt-16 pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 text-sm text-white/50">
            ...
            <a href="mailto:support@movmash.com" className="hover:text-pink-400 transition-colors">
              support@movmash.com
            </a>
          </div>
        </div>
